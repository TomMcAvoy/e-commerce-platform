#!/bin/bash
# filepath: fix-mens-fashion-404.sh

set -e

echo "🔧 Creating Missing Mens Fashion Category (Following Copilot Instructions)"
echo "Adding mens fashion page following Architecture Patterns..."

cd frontend

# Fix: Create Mens Fashion category page following DropshippingService.test.ts patterns
echo "👔 Creating Mens Fashion category page..."
mkdir -p app/mens
cat > app/mens/page.tsx << 'EOF'
'use client';
...
# Update Navigation to include Mens Fashion
echo "🧭 Adding Mens Fashion to Navigation..."
# Update the existing Navigation.tsx to include mens fashion
sed -i '' '/Fashion/i\
...
echo ""
echo "✅ Mens Fashion Category Created!"
echo ""
...
echo "3. ✅ /fashion - Womens Fashion & Style (Pink theme) 👗"
echo "4. ✅ /home - Home & Garden (Green theme) 🏠"
echo "5. ✅ /cosmetics - Beauty & Health (Purple theme) 💄"
echo "6. ✅ /sports - Sports & Fitness (Orange theme) ⚽"
echo "7. ✅ /automotive - Automotive & Parts (Blue theme) ��"
echo "8. ✅ /books - Books & Media (Brown theme) 📚"
echo "9. ✅ /toys - Toys & Games (Purple theme) 🎮"
echo "10. ✅ /baby - Baby & Kids (Yellow theme) 👶"
echo "11. ✅ /social - Social Feed (Sky theme) 👥"
echo ""
echo "🎨 Mens Fashion Unique Features:"
echo "• Professional Gray/Blue gradient theme"
echo "• Size filtering (S, M, L, XL, plus numeric sizes 28-38)"
echo "• Men's specific categories (Suits, Dress Shirts, Chinos, etc.)"
echo "• Professional affiliate programs (Men's Wearhouse, Nordstrom, Jos. A. Bank)"
echo "• Business-focused product descriptions"
echo ""
echo "💼 Men's Fashion Affiliate Programs:"
echo "• Amazon Men's Fashion (Up to 10%)"
echo "• Men's Wearhouse (5-8%) - Professional suits"
echo "• Nordstrom Men's (2-6%) - Designer wear"
echo "• Jos. A. Bank (3-7%) - Business attire"
echo ""
echo "🚀 Test the new page:"
echo "http://localhost:3001/mens"
echo ""
echo "✅ All major Amazon/Temu-style categories now complete!"
echo "✅ Navigation updated with mens fashion link!"
