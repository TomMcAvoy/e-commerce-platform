#!/bin/bash
# filepath: scripts/create-education-category.sh

set -e

echo "🎓 Creating Education Category (Following Copilot Instructions)"
echo "Implementing Abertay University-style design with your Architecture Patterns..."

cd frontend

# Create Education category page following Frontend Structure
echo "📚 Creating Education category page..."
mkdir -p app/education
cat > app/education/page.tsx << 'EOF'
'use client';
...
# Update Navigation to include Education
echo "🧭 Adding Education to Navigation..."
# Add education to the Navigation component
sed -i '' '/{ name: '\''Mens Fashion'\'', href: '\''/mens'\'', icon: '\''👔'\'' },/a\
...
echo ""
echo "✅ Education Category Created!"
echo ""
echo "📋 Following Copilot Instructions - Complete Category List:"
echo "1. ✅ /electronics - Electronics & Technology (Blue theme) 📱"
echo "2. ✅ /mens - Mens Fashion & Style (Gray/Blue theme) 👔"
echo "3. ✅ /education - Education & Learning (Indigo/Purple theme) 🎓"
echo "4. ✅ /fashion - Womens Fashion & Style (Pink theme) 👗"
echo "5. ✅ /home - Home & Garden (Green theme) 🏠"
echo "6. ✅ /cosmetics - Beauty & Health (Purple theme) 💄"
echo "7. ✅ /sports - Sports & Fitness (Orange theme) ⚽"
echo "8. ✅ /automotive - Automotive & Parts (Blue theme) 🚗"
echo "9. ✅ /books - Books & Media (Brown theme) 📚"
echo "10. ✅ /toys - Toys & Games (Purple theme) 🎮"
echo "11. ✅ /baby - Baby & Kids (Yellow theme) 👶"
echo "12. ✅ /social - Social Feed (Sky theme) 👥"
echo ""
echo "🎓 Education Category Unique Features (Abertay University Style):"
echo "• Indigo/Purple gradient hero section with academic iconography"
echo "• Program cards showing duration, format, accreditation"
echo "• Educational level filtering (Certificate → PhD)"
echo "• Study format options (Online, Hybrid, In-person)"
echo "• Career outcome focus and industry partnerships"
echo "• Academic affiliate programs (Coursera, Udemy, Skillshare, MasterClass)"
echo ""
echo "💼 Education Affiliate Programs:"
echo "• Coursera (Up to 45%) - University courses & certificates"
echo "• Udemy (8-15%) - Practical skills & professional development"  
echo "• Skillshare ($7-10) - Creative & business skills"
echo "• MasterClass ($15-50) - Premium instruction from experts"
echo ""
echo "🚀 Test the new page:"
echo "http://localhost:3001/education"
echo ""
echo "✅ Education marketplace following DropshippingService.test.ts patterns!"
echo "✅ Navigation updated with education link!"
echo "✅ Abertay University-inspired design implemented!"
